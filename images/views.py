...
def image_ranking(request):
    ...
    most_viewes = list(Image.objests.filter(id__in=image_ranking_ids))
    most_viewes.sort(key=lambda x: image_ranking_ids.index(x.id))
    return render(request, 'images/image/ranking.html', {'section': 'images', 'most_viewed': most_viewes})